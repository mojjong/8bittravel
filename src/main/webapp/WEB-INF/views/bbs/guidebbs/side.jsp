        ...
        <div id="site">
            ...
            <section id="more-pages" class="section wide-fat">
                ...
                <div class="contents-wrapper">
                    <div class="sidebar col-md-3 col-sm-6">
                        ...
                        <div class="widget widget-tabs">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade featured-posts" id="recent">
                                <!--여기 안에 지도가 들어가야대요  -->
                                ...
                                <!--다른탭  -->
                                <div class="tab-pane fade in active featured-posts" id="popular">
                    ...
                    <div class="contents col-md-6 col-sm-6">

                        <article class="post-wrap">

                            <div class="post-body">

                                <p><span class="dropcaps">N</span>am eget mi in augue pretium viverra non quis enim? Donec ornare, justo et sodales placerat, mauris ligula feugiat est, vel pharetra augue libero ut velit. Pellentesque sed augue sed tellus suscipit varius nec non tortor. Phasellus dictum tortor a nisi tempus mattis. Suspendisse blandit hendrerit mi ut sodales? Aliquam eu mattis metus. Phasellus elementum urna et vehicula ullamcorper? In tincidunt tellus urna, quis facilisis purus aliquam nec. Donec justo enim, vehicula quis ultrices eu, egestas commodo massa. Curabitur ante lectus, malesuada id sem ac, congue gravida dolor. Cras mattis erat elit, at tincidunt diam mollis in.</p>

                                <p>Nullam non interdum dui, ac lacinia erat. Sed eget ipsum dictum, eleifend lectus sed, hendrerit tortor. Ut tortor urna; ultricies at sem nec, pharetra euismod nunc. Curabitur nec tellus sed orci fermentum tincidunt. Integer faucibus est nec suscipit pharetra. Morbi vitae interdum felis. Duis nibh nulla, adipiscing quis commodo ac; accumsan vel nisi? Vestibulum sollicitudin non quam sed vulputate. In convallis vehicula risus, sed lobortis augue pretium ac! Phasellus molestie erat ac lorem aliquet, non aliquam arcu viverra.</p>

                                <h2>Etiam hendrerit nisi in hendrerit laoreet!</h2>

                                <p>Pellentesque id sollicitudin leo. Integer ac commodo nibh, sed convallis leo. Etiam hendrerit nisi in hendrerit laoreet! Nulla feugiat ipsum id turpis ultricies, sed hendrerit eros ornare. Pellentesque hendrerit, sem non tincidunt fringilla, justo metus aliquam ipsum, vitae aliquam dui eros ut leo. Donec id cursus elit. Proin in pharetra lacus, a convallis arcu. Suspendisse potenti. Fusce quis vestibulum sem. Praesent eu hendrerit lectus?</p>

                                <blockquote>Donec condimentum rhoncus ligula nec euismod. Phasellus eleifend, nulla consequat congue volutpat, est nunc vestibulum turpis, sed sollicitudin mauris mi quis felis. Ut sit amet laoreet quam, quis viverra ipsum? Curabitur sit amet leo sodales sapien condimentum ultricies quis vitae sapien. Duis venenatis nulla id lacus placerat, eget tincidunt risus viverra. Vivamus sagittis mollis nisi id eleifend! Cras eget magna sodales, tristique est non; hendrerit odio. Quisque non bibendum erat? Vestibulum facilisis ut odio non pretium. Nam at massa facilisis, fringilla tellus id, hendrerit lorem?</blockquote>

                                <p>Ut tortor tellus, tempus vitae ligula quis, fermentum rhoncus nulla. Ut quis dictum augue, ut pharetra ligula. Nullam vel placerat dolor, et consequat elit. Donec ornare nisi venenatis nunc interdum ultricies? Integer mi dolor, pharetra vitae eros accumsan; lobortis semper leo! Sed elit dui; scelerisque id tempus ut, porttitor vel risus. Cras at semper quam. Aliquam vel gravida enim. Aliquam dapibus interdum massa, blandit ullamcorper augue ornare non. Donec eu dolor a leo laoreet posuere.</p>

                                <p>Sed malesuada risus vitae sem tincidunt dapibus. Proin sollicitudin egestas congue. Fusce bibendum, libero sed venenatis iaculis, magna lacus vulputate elit, quis bibendum mauris leo porttitor odio. Donec interdum non diam vitae posuere. Vivamus ligula nisi, semper at ornare et, malesuada pharetra est. Nunc sit amet orci vitae lectus facilisis ultricies vel at sem. Aliquam erat volutpat. Nunc sed dictum est. Suspendisse pellentesque euismod turpis, nec porta nibh tincidunt id. Etiam a dolor tincidunt, posuere odio ut, pharetra mauris. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Integer condimentum accumsan eros at tempor. Mauris condimentum imperdiet dui sit amet ornare. Nulla lacus leo, tristique sed purus sit amet, accumsan vestibulum dui. </p>

                                <h3 class="block-title">Etiam hendrerit nisi in hendrerit laoreet!</h3>

                                <p>Curabitur sed libero euismod, egestas elit in, aliquet erat. Duis ut nibh condimentum turpis dapibus vehicula pretium vel metus. Nullam tempus massa id eros condimentum elementum. Donec aliquet enim eget lacus venenatis dapibus. Phasellus ac odio ipsum. Sed congue, metus non aliquam interdum, arcu odio posuere lorem, a semper lacus est a velit. Sed auctor odio sed nisi vulputate accumsan. Cras quis sem dapibus, dictum neque nec, scelerisque ligula. Quisque sit amet neque velit. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Curabitur ultricies est tortor, sit amet volutpat purus tempor eget. Praesent adipiscing urna id commodo lobortis. </p>
                    ...
                    <div class="sidebar col-md-3 col-sm-6">
                            ...
                            <div class="featured-posts">
                                <div class="media">
                                    <a class="pull-left" href="#">
                                        <img class="media-object" src="images/blog/blog-sidebar-4.jpg" alt="">
                                    </a>
                                    <div class="media-body">
                                        <h4 class="media-heading"><a href="#">Sed vel dapibus risus</a></h4>
                                ...
                                <div class="media">
                                    <a class="pull-left" href="#">
                                        <img class="media-object" src="images/blog/blog-sidebar-3.jpg" alt="">
                                    </a>
                                    <div class="media-body">
                                        <h4 class="media-heading"><a href="#">Praesent a purus vel </a></h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse vel euismod neque.</p>
                                        <p class="post-date"><i class="fa fa-clock-o"></i> about 5 house ago</p>
                                    </div>
                                </div>
                        ...
                        <div class="widget">
                            ...
                            <ul class="categories clearfix">
                                <li><i class="fa fa-angle-double-right"></i> <a href="#">All</a></li>
                                <li class="active"><i class="fa fa-angle-double-right"></i> <a href="#">News from Us</a></li>
                                <li><i class="fa fa-angle-double-right"></i> <a href="#">Web Design Tuts</a></li>
                                <li><i class="fa fa-angle-double-right"></i> <a href="#">WordPress Tips</a></li>
                                <li><i class="fa fa-angle-double-right"></i> <a href="#">HTML5 &amp; CSS3</a></li>
                                <li><i class="fa fa-angle-double-right"></i> <a href="#">Other Works</a></li>
                            </ul>
                        </div><!-- /.widget -->
                    </div>
