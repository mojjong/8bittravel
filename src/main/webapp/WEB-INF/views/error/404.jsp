            ...
            <section id="more-pages" class="section wide-fat">
                <div class="area-404-2">
                    ...
                    <div class='content-holder'>
                        ...
                        <img class='error-image margin-top-30' alt='error 404' src='/resources/images/404.png'>

                        <h1>Error 404: Page not found</h1>

                        <h3>You are lost somewhere</h3>

                        <p class="margin-top-30"><a class="button btn-lg" href="/main/region/">Go back to home</a></p>
