		...
		<div class="row thumbnails">
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="thumbnail no-border no-padding">
					<div class="media">
						<img src="/resources/images/portfolio/portfolio-1.jpg" alt="">
						<div class="caption hovered">
							<div class="caption-wrapper div-table">
								<div class="caption-inner div-cell">
									<p class="caption-buttons">
										<a href="/resources/images/portfolio/portfolio-1-big.jpg"
											class="btn caption-zoom" data-gal="prettyPhoto"><i
											class="fa fa-search"></i></a> <a href="#"
											class="btn caption-link"><i class="fa fa-link"></i></a>
									</p>
								</div>
							</div>
						</div>
					...
					<div class="caption after-media">
						<h3 class="caption-title">Project Title 1</h3>
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="thumbnail no-border no-padding">
					<div class="media">
						<img src="/resources/images/portfolio/portfolio-2.jpg" alt="">
						<div class="caption hovered">
							<div class="caption-wrapper div-table">
								<div class="caption-inner div-cell">
									<p class="caption-buttons">
										<a href="/resources/images/portfolio/portfolio-2-big.jpg"
											class="btn caption-zoom" data-gal="prettyPhoto"><i
											class="fa fa-search"></i></a> <a href="#"
											class="btn caption-link"><i class="fa fa-link"></i></a>
									</p>
					...
					<div class="caption after-media">
						<h3 class="caption-title">Project Title 2</h3>
						<p class="caption-category">
							<a href="#">Category</a>
						</p>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="thumbnail no-border no-padding">
					<div class="media">
						<img src="/resources/images/portfolio/portfolio-3.jpg" alt="">
						<div class="caption hovered">
							<div class="caption-wrapper div-table">
								<div class="caption-inner div-cell">
									<p class="caption-buttons">
										<a href="/resources/images/portfolio/portfolio-3-big.jpg"
											class="btn caption-zoom" data-gal="prettyPhoto"><i
											class="fa fa-search"></i></a> <a href="#"
											class="btn caption-link"><i class="fa fa-link"></i></a>
									</p>
					...
					<div class="caption after-media">
						<h3 class="caption-title">Project Title 3</h3>
						<p class="caption-category">
							<a href="#">Category</a>
						</p>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="thumbnail no-border no-padding">
					<div class="media">
						<img src="/resources/images/portfolio/portfolio-4.jpg" alt="">
						<div class="caption hovered">
							<div class="caption-wrapper div-table">
								<div class="caption-inner div-cell">
									<p class="caption-buttons">
										<a href="/resources/images/portfolio/portfolio-4-big.jpg"
											class="btn caption-zoom" data-gal="prettyPhoto"><i
											class="fa fa-search"></i></a> <a href="#"
											class="btn caption-link"><i class="fa fa-link"></i></a>
									</p>
					...
					<div class="caption after-media">
						<h3 class="caption-title">Project Title 4</h3>
						<p class="caption-category">
							<a href="#">Category</a>
						</p>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="thumbnail no-border no-padding">
					<div class="media">
						<img src="/resources/images/portfolio/portfolio-5.jpg" alt="">
						<div class="caption hovered">
							<div class="caption-wrapper div-table">
								<div class="caption-inner div-cell">
									<p class="caption-buttons">
										<a href="/resources/images/portfolio/portfolio-5-big.jpg"
											class="btn caption-zoom" data-gal="prettyPhoto"><i
											class="fa fa-search"></i></a> <a href="#"
											class="btn caption-link"><i class="fa fa-link"></i></a>
									</p>
					...
					<div class="caption after-media">
						<h3 class="caption-title">Project Title 5</h3>
						<p class="caption-category">
							<a href="#">Category</a>
						</p>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="thumbnail no-border no-padding">
					<div class="media">
						<img src="/resources/images/portfolio/portfolio-6.jpg" alt="">
						<div class="caption hovered">
							<div class="caption-wrapper div-table">
								<div class="caption-inner div-cell">
									<p class="caption-buttons">
										<a href="/resources/images/portfolio/portfolio-6-big.jpg"
											class="btn caption-zoom" data-gal="prettyPhoto"><i
											class="fa fa-search"></i></a> <a href="#"
											class="btn caption-link"><i class="fa fa-link"></i></a>
									</p>
					...
					<div class="caption after-media">
						<h3 class="caption-title">Project Title 6</h3>
						<p class="caption-category">
							<a href="#">Category</a>
						</p>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="thumbnail no-border no-padding">
					<div class="media">
						<img src="/resources/images/portfolio/portfolio-7.jpg" alt="">
						<div class="caption hovered">
							<div class="caption-wrapper div-table">
								<div class="caption-inner div-cell">
									<p class="caption-buttons">
										<a href="/resources/images/portfolio/portfolio-7-big.jpg"
											class="btn caption-zoom" data-gal="prettyPhoto"><i
											class="fa fa-search"></i></a> <a href="#"
											class="btn caption-link"><i class="fa fa-link"></i></a>
									</p>
					...
					<div class="caption after-media">
						<h3 class="caption-title">Project Title 7</h3>
						<p class="caption-category">
							<a href="#">Category</a>
						</p>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="thumbnail no-border no-padding">
					<div class="media">
						<img src="/resources/images/portfolio/portfolio-8.jpg" alt="">
						<div class="caption hovered">
							<div class="caption-wrapper div-table">
								<div class="caption-inner div-cell">
									<p class="caption-buttons">
										<a href="/resources/images/portfolio/portfolio-8-big.jpg"
											class="btn caption-zoom" data-gal="prettyPhoto"><i
											class="fa fa-search"></i></a> <a href="#"
											class="btn caption-link"><i class="fa fa-link"></i></a>
									</p>
					...
					<div class="caption after-media">
						<h3 class="caption-title">Project Title 8</h3>
						<p class="caption-category">
							<a href="#">Category</a>
						</p>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="thumbnail no-border no-padding">
					<div class="media">
						<img src="/resources/images/portfolio/portfolio-9.jpg" alt="">
						<div class="caption hovered">
							<div class="caption-wrapper div-table">
								<div class="caption-inner div-cell">
									<p class="caption-buttons">
										<a href="/resources/images/portfolio/portfolio-9-big.jpg"
											class="btn caption-zoom" data-gal="prettyPhoto"><i
											class="fa fa-search"></i></a> <a href="#"
											class="btn caption-link"><i class="fa fa-link"></i></a>
									</p>
					...
					<div class="caption after-media">
						<h3 class="caption-title">Project Title 9</h3>
						<p class="caption-category">
							<a href="#">Category</a>
						</p>
					</div>
