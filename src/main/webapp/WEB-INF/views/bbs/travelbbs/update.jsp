                    ...
                    <div class="row">
                        <div class="contents col-sm-8 col-md-9">
                            ...
                            <div class="form-holder booking-form">
                                <form class="info-form" name="writeForm" action="/bbs/travelbbs/update" method="post">
                                    ...
                                    <div class="row field-row">
                                    	<div class="col-xs-10">
		                                    ...
		                                    <br />
		                                    <textarea class="col-xs-12" rows="7">${vo.content }</textarea>
	                                  	</div>
        							</div>    
                                    ...
                                    <div class="row field-row">
                                        ...
                                        <div class="col-field-left col-xs-5 col-sm-3">
                                             ...
                                             <input id="check-in-date" class="traveline_date_input" type="text" value="${vo.startdate }" />
                                         ...
                                         <div class="col-field-right col-xs-5 col-sm-3">
                                             ...
                                             <input id="check-out-date" class="traveline_date_input" type="text" value="${vo.enddate }" />
                                    ...
                                    <div class="row field-row">
                                        ...
                                        <div class="col-xs-10 col-sm-6">
                                    		...
                                    		<br />
                                            <input class="required " value="${vo.cost }">
                                        </div>
                                    </div>
                                    <br>
                                    <button type="submit" class="button green narrow">수정</button>
